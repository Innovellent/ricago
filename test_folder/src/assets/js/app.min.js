...
function _init() {
	...
	$.spv.layout = {
		...
		fix : function () {
			...
			if ($("body").hasClass("fixed"))
				...
				var e = $($.spv.options.controlSidebarOptions.selector);
				"undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
			}
		},
		fixSidebar : function () {
			return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.spv.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
							destroy : !0
	...
	$.spv.pushMenu = {
		activate : function (a) {
			...
			($.spv.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
		},
		expandOnHover : function () {
			var a = this,
			b = $.spv.options.screenSizes.sm - 1;
	...
	$.spv.controlSidebar = {
		activate : function () {
			var a = this,
			b = $.spv.options.controlSidebarOptions,
			c = $(b.selector),
	...
	$.spv.boxWidget = {
		selectors : $.spv.options.boxWidgetOptions.boxWidgetSelectors,
		icons : $.spv.options.boxWidgetOptions.boxWidgetIcons,
		animationSpeed : $.spv.options.animationSpeed,
		activate : function (a) {
			var b = this;
			a || (a = document),
...
if ("undefined" == typeof jQuery)
	throw new Error("spv requires jQuery");
$.spv = {}, $.spv.options = {
	...
	"undefined" != typeof spvOptions && $.extend(!0, $.spv.options, spvOptions);
	var a = $.spv.options;
	_init(),
	$.spv.layout.activate(),
	$.spv.tree(".sidebar"),
	a.enableControlSidebar && $.spv.controlSidebar.activate(),
	...
	a.sidebarPushMenu && $.spv.pushMenu.activate(a.sidebarToggleSelector),
	a.enableBSToppltip && $("body").tooltip({
		selector : a.BSTooltipSelector
	}),
	a.enableBoxWidget && $.spv.boxWidget.activate(),
...
(jQuery), function (a) {
	...
	a.fn.activateBox = function () {
		a.spv.boxWidget.activate(this)
	},
	a.fn.toggleBox = function () {
		var b = a(a.spv.boxWidget.selectors.collapse, this);
		a.spv.boxWidget.collapse(b)
	},
	a.fn.removeBox = function () {
		var b = a(a.spv.boxWidget.selectors.remove, this);
		a.spv.boxWidget.remove(b)
	}
}
(jQuery), function (a) {
	"use strict";
